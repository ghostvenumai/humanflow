    ...
    async def stream_response(
        ...
        if self._authoritative_transaction_context:
            system_prompt += (
                ...
                "natürlich als Termin. In jeder Antwort mit aktivem appointment_state "
                "musst du ausdrücklich das Wort „Termin“ verwenden. Stelle danach "
                "höchstens eine Frage zum nächsten "
