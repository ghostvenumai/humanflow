...
| Primary TTS | `ElevenLabsStreamingTTSProvider` | REAL, CURRENTLY CONFIGURATION-BLOCKED | Uses `eleven_flash_v2_5` and streams 16 kHz PCM. The latest real smoke returned `404 / voice_not_found`; therefore no live voice-quality claim exists yet. |
