...
| Primary TTS | `ElevenLabsStreamingTTSProvider` | REAL, CURRENTLY ACCOUNT-BLOCKED | Uses `eleven_flash_v2_5` and streams 16 kHz PCM. After correcting the Voice-ID, the latest real smoke reached the account and returned `402 / payment_required`; therefore no live voice-quality claim exists yet. |
